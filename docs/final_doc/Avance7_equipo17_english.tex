...
The exploratory data analysis (Milestone~1) established the design
...
\subsection{Individual models (Milestone 4)}
...
\begin{table}[htbp]
\caption{Individual model comparison (Milestone 4)}
...
\subsection{Ensemble family (Milestone 5)}
...
\begin{table}[htbp]
\caption{Ensemble comparison --- held-out data (Milestone 5)}
\label{tab:ensembles}
\centering
\begin{tabular}{lccc}
\toprule
...
% ══════════════════════════════════════════════════════════════════════════════
\section{FarSLIP Integration and Frontend (Milestone 6)}
% ══════════════════════════════════════════════════════════════════════════════
...
Milestone~6 deploys the complete conversational copilot with the following
...
completely unseen data, representing a measured and reproducible improvement
of +12.3 points.
