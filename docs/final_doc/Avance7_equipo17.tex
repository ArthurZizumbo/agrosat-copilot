...
El análisis exploratorio de datos (Avance~1) estableció las hipótesis de
...
\subsection{Modelos individuales (Avance 4)}
...
\begin{table}[htbp]
\caption{Comparativa de modelos individuales (Avance 4)}
...
\subsection{Familia de ensambles (Avance 5)}
...
\begin{table}[htbp]
\caption{Comparativa de ensambles --- datos no vistos (Avance 5)}
\label{tab:ensembles}
\centering
\begin{tabular}{lccc}
\toprule
...
% ══════════════════════════════════════════════════════════════════════════════
\section{Integración FarSLIP y Frontend (Avance 6)}
% ══════════════════════════════════════════════════════════════════════════════
...
El Avance~6 despliega el copiloto conversacional completo con las
...
\textbf{F1-macro~0.749} sobre datos completamente no vistos, con una mejora
medida y reproducible de +12.3 puntos.
