...
(Estonia/Latvia/Portugal), and the qualitative Mexican demonstration
areas.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{figures/us-070/aoi_italy.png}
  \caption{Italian area of interest used for the FarSLIP contrastive
  distillation (\texttt{farslip-clip-italy-v1}), one node of the
  multi-region footprint of AgroSatCopilot. Basemap and AOI overlay;
  contains modified Copernicus Sentinel data. AlphaEarth
  \texttt{SATELLITE\_EMBEDDING/V1/ANNUAL} v1.1
  (CC-BY-4.0)~\cite{brown2025alphaearth}.}
  \label{fig:aoi-italy}
\end{figure}
