...
% Figures: paper/figures/us-073-transfer/{kshot_curve,mexico_phenology,worldcereal_tropical_transfer}.{png,svg}
%          paper/figures/us-075/sen4agrinet_per_class_iou_f1.png
%          paper/figures/us-076/eurocropsml_per_class_f1_vs_k.png
%          ../docs/us-planning/figures/eurocropsml_alphaearth_vs_s2_fewshot.png
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.9\linewidth]{../docs/us-planning/figures/eurocropsml_alphaearth_vs_s2_fewshot.png}
...
leaves, not more regions. The model remains useful as a richer \emph{macro} vocabulary and a
fine-grained hypothesis generator (the Mexico qualitative demo confidently, and wrongly, maps
tropical orchards to \texttt{grassland}, with no tropical-orchard class to offer), but not yet
as a production fine classifier. We report this so the limit is on record, not hidden.
...
explanation and on-premise data sovereignty via Qwen3.5-35B-A3B~\cite{yang2025qwen3} served
with vLLM GPTQ-Int4 on a single GPU), nor any $\geq$0.80 F1 in Mexico or the tropics. The
