...
def _make_fold5_frame(*, with_missing: bool = False) -> pl.DataFrame:
    ...
    rows: list[dict[str, object]] = [
        {"model": "tsvit-pheno", "miou": 0.6253, "f1_macro": 0.7500,
         "pixel_accuracy": 0.8759, "fold": 5, "n_patches": 480, "status": "ok"},
        {"model": "utae", "miou": 0.5101, "f1_macro": 0.6402,
         "pixel_accuracy": 0.8210, "fold": 5, "n_patches": 480, "status": "ok"},
        {"model": "unet", "miou": 0.3502, "f1_macro": 0.4803,
         "pixel_accuracy": 0.7204, "fold": 5, "n_patches": 480, "status": "ok"},
        {"model": "deeplabv3plus", "miou": 0.2709, "f1_macro": 0.3864,
         "pixel_accuracy": 0.6743, "fold": 5, "n_patches": 480, "status": "ok"},
        {"model": "segformer", "miou": 0.1805, "f1_macro": 0.2906,
         "pixel_accuracy": 0.5907, "fold": 5, "n_patches": 480, "status": "ok"},
        {"model": "anysat", "miou": 0.2204, "f1_macro": 0.3305,
         "pixel_accuracy": 0.6108, "fold": 5, "n_patches": 480, "status": "ok"},
    ]
    if with_missing:
        rows[-1] = {
            "model": "anysat", "miou": None, "f1_macro": None,
            "pixel_accuracy": None, "fold": 5, "n_patches": 0, "status": "missing",
        }

    schema = {
        "model": pl.Utf8, "miou": pl.Float64, "f1_macro": pl.Float64,
        "pixel_accuracy": pl.Float64, "fold": pl.Int64, "n_patches": pl.Int64,
        "status": pl.Utf8,
    }
