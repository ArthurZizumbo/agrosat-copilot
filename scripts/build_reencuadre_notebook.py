...
CELLS: list[nbf.NotebookNode] = [
    ...
    _code(
        ...
        "# Defensa US-022c P2: cualquier NaN en f1_macro indica un lookup XGB sin match.\n"
        "if comparison_table.height > 0 and 'f1_macro' in comparison_table.columns:\n"
        "    assert not comparison_table['f1_macro'].is_null().any(), 'XGBoost NaN bug (US-022c P2)'\n"
